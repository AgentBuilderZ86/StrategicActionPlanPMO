...
export const NAV_ITEMS = [
  ...
  { href: '/actions', label: "Plan d'actions", icon: 'actions', modules: ['ECOSYSTEME', 'INTERNE'] as PmoType[] },
  { href: '/initiatives', label: 'Initiatives & projets', icon: 'actions', modules: ['SI'] as PmoType[] },
  { href: '/planning', label: 'Planning', icon: 'planning', modules: PMO_TYPES },
  { href: '/pipeline', label: 'Backlog & pipeline', icon: 'pipeline', modules: ['SI'] as PmoType[] },
  { href: '/delivery', label: 'Indicateurs delivery', icon: 'delivery', modules: ['SI'] as PmoType[] },
  { href: '/agile', label: 'Sprints', icon: 'agile', modules: ['SI'] as PmoType[] },
